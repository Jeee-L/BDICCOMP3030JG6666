<template>
  ...
  <ul
    class="nav"
    v-if="menus"
    v-bind:style="{ marginLeft: '-' + margin.left + 'px', marginRight: '-'+ margin.right + 'px' }"
  >
    ...
    <li
      ...
      v-bind:class="{ 'show': controls.left }"
      v-on:click="controlLeft"
    >
    ...
    <li
      ...
      v-bind:class="{ 'show': controls.right }"
      v-on:click="controlRight"
    >
