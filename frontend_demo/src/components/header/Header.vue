	...
	<div>
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				...
				<router-link to="/dashboard/v2" class="navbar-brand"><span class="navbar-logo"></span> <b>Hibernia-Sino</b> Travel Insurance</router-link>
				...
				<li class="dropdown navbar-user">
					<b-dropdown variant="link" menu-class="dropdown-menu-right">
						<template slot="button-content">
							...
							<span class="d-none d-md-inline">Princess Phoebe</span> <b class="caret"></b>
						</template>
