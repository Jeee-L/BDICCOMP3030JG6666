  ...
  <div>
    ...
    <ol class="breadcrumb pull-right">
      ...
      <li class="breadcrumb-item active">
        <a href="javascript:;">Data Tables</a>
      </li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Vue Data Tables
      <small>official documentation
        <a href="https://xaksis.github.io/vue-good-table/" target="_blank">here</a>
      </small>
    </h1>
    <!-- end page-header -->
    <vue-good-table
  ...
  data() {
    return {
      ...
      rows: [
        ...
        {
          id: 5,
          image: "/assets/img/user/user-5.jpg",
          name: "Dan",
          job: "Team Leader",
          age: 40,
        ...
        {
          id: 6,
          image: "/assets/img/user/user-6.jpg",
          name: "Mollie",
        ...
        {
          id: 7,
          image: "/assets/img/user/user-7.jpg",
          name: "Bert",
          job: "Backend Developer",
          age: 23,
          createdAt: "2018-10-31",
        ...
        {
          id: 9,
          image: "/assets/img/user/user-9.jpg",
          name: "Shannon",
          job: "Android Developer",
          age: 42,
          createdAt: "2018-10-31",
        ...
        {
          id: 10,
          image: "/assets/img/user/user-10.jpg",
          name: "Emilia",
          job: "iOS Developer",
          age: 33,
          createdAt: "2018-10-31",
        ...
        {
          id: 11,
          image: "/assets/img/user/user-11.jpg",
          name: "Kierran",
          job: "Java Developer",
          age: 22,
          createdAt: "2018-10-31",
        ...
        {
          id: 13,
          image: "/assets/img/user/user-13.jpg",
          name: "Georgia",
          job: "Java Developer",
          age: 20,
          createdAt: "2018-10-31",
        ...
        {
          id: 14,
          image: "/assets/img/user/user-14.jpg",
          name: "Nazifa",
          job: "Java Developer",
          age: 34,
          createdAt: "2018-10-31",
